  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Cores de espaço
        space: {
          designer: "hsl(var(--space-designer))",
          audiovisual: "hsl(var(--space-audiovisual))",
          social: "hsl(var(--space-social))",
          traffic: "hsl(var(--space-traffic))",
          admin: "hsl(var(--space-admin))",
          coordination: "hsl(var(--space-coordination))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
