    ...
    <AppLayout>
      <div className="p-6 space-y-6">
        ...
        <Tabs defaultValue="bottlenecks" className="space-y-4">
          <TabsList className="flex-col h-auto p-4 bg-gradient-to-b from-muted/50 to-muted/30 backdrop-blur-sm rounded-xl border border-border/50 shadow-sm max-w-5xl mx-auto">
            {/* Primary Row - 10 columns */}
            <div className="grid grid-cols-10 gap-3 w-full">
              <TabsTrigger 
                value="bottlenecks" 
                className="flex flex-col items-center gap-1 p-2.5 h-auto rounded-lg bg-muted/50 hover:bg-muted/80 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/10 transition-all duration-200 hover:shadow-sm hover:-translate-y-0.5"
              >
              ...
              {/* Empty slot to align with cards above */}
