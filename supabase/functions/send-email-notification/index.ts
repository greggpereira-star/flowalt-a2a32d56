...
// Get from env vars directly to ensure we have the most up to date values
const getSender = () => Deno.env.get("RESEND_FROM_EMAIL_FLOW") || Deno.env.get("RESEND_FROM_EMAIL") || "Flowalt <onboarding@resend.dev>";
